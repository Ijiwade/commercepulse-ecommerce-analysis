...
KEY INSIGHTS
* Revenue is primarily generated by customers with low refund ratios, while customers with higher refund ratios contribute relatively little revenue. This suggests that refund-related losses are concentrated among lower-value customers rather than top spenders.
* Customer purchase intervals vary widely, ranging from 9 days to over 100 days, indicating clear behavioral segmentation between loyal, occasional, and infrequent buyers. This suggests opportunities for targeted retention and re-engagement strategies.
* The business generated approximately 52k in net revenue over the analyzed period, with refunds totaling around 6k. However, July shows negative net revenue due to refunds exceeding sales, which may indicate either operational issues or incomplete transactional data and should be investigated further.
